...
def build_vocab_prompt(input_text: str, level: str, number_of_entries: int, book_id: Optional[int], word_type: Optional[str]) -> str:
    ...
    - Examples (3 example sentences; use book examples if available, or create them. Sentence have to contain the word. Word should be bold. Seperate each example with a <br> tag. e.g. Uit welk land komt u?<br>Uit welk land kom je?)  
